...
<?php function isActive($data){
  return ($data==1)?'<span class="badge badge-success">Activate</span>':'<span class="badge badge-danger">Deactivated</span>';
} ?>
...
<?php 
 //Get Message 
 function getMessage($msg,$sts,$time){
 	global $sts;
 	global $msg;
if (!empty($msg)) {
# code...
...
$mail->Username = "marsadakbar@gmail.com";

//Password to use for SMTP authentication
$mail->Password = "marsad000";
